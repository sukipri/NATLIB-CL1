...
<div class="card">
 <div class="headimg"> <br>
        <a href='#' class="btn btn-secondary  mx-1"><i class='fas fa-folder'></i> RJ #2 IN-Progress Dataview Pending</a>
        &nbsp
...
$idps_json =  $data2_jsonfor_get['resource']['id'];
    ...
    <tr>
        ...
        <td><?PHP echo "<b>Kunjungan Baru</b><br>".$pl_vrjkj1_sww['rjkj1_idssen_01']; ?></td>
