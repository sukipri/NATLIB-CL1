  ...
  <div class="panel-body">
    ...
    //Script Upload File..
        ...
        while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
            $save_rjkj_01 = $CL_Q($CONN01,"$IN nat_rjkj1(idmain_rjkj1,rjkj1_nikpasien_01,rjkj1_namapasien_01,rjkj1_nikdokter_01,rjkj1_lokid_01,rjkj1_tglmasuk_01,rjkj1_status_01)VALUES('$data[0]','$data[1]','$data[5]','$data[2]','$data[3]','$data[4]','1')");
            if($save_rjkj_01){
