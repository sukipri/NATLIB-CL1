...
<table class="table table-sm table-bordered table-striped">
    ...
    <?PHP
        ...
        if(isset($_POST['btn_tglkj1'])){
            echo"<META HTTP-EQUIV='Refresh' Content='0; URL=?PG_SA=PL_SSRJ_KJ01VIEWKIRIM&TG01=$txt_tglkj1'>";
        } 
        #DATA Kunjungan Awal
        $pl_vrjkj1_sw = $CL_Q($CONN01," $CL_SL nat_rjkj1 WHERE (rjkj1_tglmasuk_01 BETWEEN '$TG01' AND '$TG01') AND  NOT rjkj1_status_01='3' order by rjkj1_tglmasuk_01 desc");
